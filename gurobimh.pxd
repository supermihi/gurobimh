...
cdef extern from 'gurobi_c.h':
    ...
    # callback "what"'s
    const int GRB_CB_MIPNODE_OBJBST, GRB_CB_SPX_OBJVAL, GRB_CB_MIPSOL_NODCNT, GRB_CB_MIP_OBJBND, GRB_CB_MIP_SOLCNT, \
        GRB_CB_MIP_NODCNT, GRB_CB_MIP_OBJBST, GRB_CB_RUNTIME
